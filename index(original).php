                    ...
                    <div class="col-12">
                        ...
                        <?php
                            ...
                            foreach($all_spells_data -> spells as $key => $value) {
                                // $spell_id = $value -> id;
                                // $api_single_spell = "https://dnd-rolling-chart-api.herokuapp.com/api/spells/spellById/${spell_id}";
                                // $json_api_single_spell = file_get_contents($api_single_spell);
                                // $single_spell_data = json_decode($json_api_single_spell);

                                print_r($single_spell_data);
                            ...
                            echo '<div class="col-6 col-md-4">';
                                echo '<p class="mb-0 spell-key">Name</p>';
                                // echo "<p><strong>${spell_name}</strong></p>";
                            echo '</div>';
                            ...
                            // Spell Casting Time
                            echo '<div class="col-6 col-md-4">';
                                echo '<p class="mb-0 spell-key">Casting Time</p>';
                                // echo "<p><strong>${spell_casting_time}</strong></p>";
                            echo '</div>';
                            ...
                            // Spell Range
                            echo '<div class="col-6 col-md-4">';
                                echo '<p class="mb-0 spell-key">Range</p>';
                                echo '<p><strong>{props.range}</strong></p>';
                            echo '</div>';

                            // Spell Duration
                            echo '<div class="col-6 col-md-4">';
                                echo '<p class="mb-0 spell-key">Duration</p>';
                                echo '<p><strong>{props.duration}</strong></p>';
                            echo '</div>';
                            ...
                            echo '<div class="col-12">';
                                echo '<p class="mb-0 spell-key">Description</p>';
                                echo '<p><strong>{props.description}</strong></p>';
                            echo '</div>';
                            ...
                            echo '<div class="col-6 col-md-2">';
                                echo '<p class="mb-0 spell-key">School</p>';
                                echo '<p><strong>{props.school}</strong></p>';
                            echo '</div>';

                            // Spell available to Classes
                            echo '<div class="col-6 col-md-2">';
                                echo '<p class="mb-0 spell-key">classes</p>';
                                echo '<p><strong>{props.classes}</strong></p>';
                            echo '</div>';
                        }
                    }
                            ?>
